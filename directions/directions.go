...
type Bounds struct {
    ...
    // The south west corner o the bounded area.
...
// This represents a distance covered in a step or leg.
...
func Directions(ctx context.Context, origin, destination string) (Response, error) {
